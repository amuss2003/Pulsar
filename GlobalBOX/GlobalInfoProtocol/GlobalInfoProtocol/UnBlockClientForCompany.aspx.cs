...
{
    public partial class UnBlockClientForCompany : System.Web.UI.Page
    {
                        ...
                        if ((CompanyVATBlocked != null) && (CompanyVATBlocked != ""))
                        {
                            if ((CountryIDRequest != null) && (CountryIDRequest != ""))
                            {
                                if ((CompanyVATRequest != null) && (CompanyVATRequest != ""))
                                {
                                    ...
                                    {
                                        dblayer.DeleteCompanyBlocking(CountryIDBlocked, CompanyVATBlocked, CountryIDRequest, CompanyVATRequest);
